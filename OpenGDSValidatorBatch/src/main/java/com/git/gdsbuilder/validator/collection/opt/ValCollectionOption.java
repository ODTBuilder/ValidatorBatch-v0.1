...
public class ValCollectionOption extends HashMap<ValCollectionOptionType, Object> {
	...
	public enum ValCollectionOptionType {
		ENTITYNONE("EntityNONE"), EDGEMATCHMISS("EdgeMatchMiss"), REFZVALUEMISS("RefZValueMiss"), REFATTRIBUTEMISS(
				"RefAttributeMiss"), REFENTITYNONE("RefEntityNone"), UNDERSHOOT("UnderShoot");
	...
	public void putRefEntityNone(boolean flag) {
		super.put(ValCollectionOptionType.REFENTITYNONE, flag);
	}
